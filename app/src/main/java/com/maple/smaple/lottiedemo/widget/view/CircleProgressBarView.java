...
public class CircleProgressBarView extends View {
    ...
    private int circleBgColor = Color.parseColor("#55FF4081");
    /**
     * 进度条颜色
     */
    //private int progressColor = 0xFFf66b12;
    private int progressColor = Color.parseColor("#C70010");;
    ...
    private void initPaint() {
        ...
        circlePaint = getPaint(6, Color.WHITE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画小白圆点
        mCenterY = 30;
        canvas.drawCircle(centerX, mCenterY, 2, circlePaint);
        if (isDrawCenterProgressText) {
           // drawCenterProgressText(canvas, mProgress + "%");
            drawCenterProgressText(canvas, (float)(Math.round(mProgress*10))/10 + "%");
        }
    }
