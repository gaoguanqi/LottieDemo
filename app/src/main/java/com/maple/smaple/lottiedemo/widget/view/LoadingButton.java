...
public class LoadingButton extends  android.support.v7.widget.AppCompatButton{
  ...
  //  private static final int POINT_COLOR_1 = -256;
    //private static final int POINT_COLOR_2 = 0x7FFFFFFF;
   // private static final int POINT_COLOR_2 = -65536;
    //private static final int POINT_COLOR_3 = 0xFFFFFFFF;
    //private static final int POINT_COLOR_3 = -7829368;

    private static  final int POINT_COLOR_1 = Color.parseColor("#AABBCC");
    private static  final int POINT_COLOR_2 = Color.parseColor("#BBCCAA");;
    private static  final int POINT_COLOR_3 = Color.parseColor("#CCBBAA");;
